        ...
        protected Void run() throws Exception {
            ...
            try {
                ...
                String password = c == null
                        ? null 
                        : (c.getPassword() == null ? null : c.getPassword().getPlainText()) ;
                if (c == null) {
                ...
                markUnstable(consoleLogger,
                        "Build information NOT sent: this step needs a Jenkins URL (go to Manage Jenkins > Configure System; click Save)");
